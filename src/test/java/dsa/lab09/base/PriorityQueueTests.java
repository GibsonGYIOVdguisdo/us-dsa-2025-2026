...
import dsa.lib.*;
import dsa.lab09.data.PriorityQueueItemSourceData.IntsToInts;
import dsa.lab09.data.PriorityQueueItemSourceData.IntsToStrings;
...
import static dsa.lab09.data.PriorityQueueItemData.INTS_TO_INTS;
import static dsa.lab09.data.PriorityQueueItemData.INTS_TO_STRINGS;
      ...
      return Source.from(IntsToInts.NON_EMPTY, IntsToStrings.NON_EMPTY)
        .flatReplace((sources) ->
          sources.replace((source) -> new Object[]{
              TestClassUtils.construct(priorityQueueClass, source),
