...
import dsa.lib.PassthroughString;
  ...
  implements Container<Vertex>
{
  ...
  public String toString(String indent)
  {
    return ToStringUtils.toTypedString(
      this, ArrayUtils.toUntypedString(
        new Object[]{
          new PassthroughString(String.join(
            ", ", ArrayUtils.replace(
              ArrayUtils.from(this.items()),
              (v) -> ToStringUtils.toString(v)))),
          new PassthroughString(String.join(
            ", ", ArrayUtils.replace(
              ArrayUtils.from(this.edges()),
              (e) -> ToStringUtils.toString(e))))}, indent));
  }
