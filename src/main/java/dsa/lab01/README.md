...
methods with lines like these in them, you can tell that that method is for
*you* to implement. Simply delete these lines and replace them with the correct
code that does what the method in question is supposed to do. In this case, it
should only be one line. When you think you've got it right, compare your
solution with ours, provided in the `lab01\solutions\StringArray.java` file.
